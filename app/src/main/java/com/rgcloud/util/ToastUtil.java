...
/**
 * Created by wangxuejiao on 2017/2/5.
 */
...
public class ToastUtil {
    ...
    private static void showToast(@StringRes int resId, int duration) {
         showToast(TCApplication.getApplication().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
         showToast(String.format(TCApplication.getApplication().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(TCApplication.getApplication(), text, duration);
        } else {
            sToast.setText(text);
