...
public class TCWordOperationView extends View {
    ...
    private void init() {
        ...
        if (mEditDrawble != null) {
            mEditDrawableWidth = mEditDrawble.getIntrinsicWidth();
            mEditDrawableHeight = mEditDrawble.getIntrinsicHeight();
        }
        if (mDeleteDrawable != null) {
            mDeleteDrawbleWidth = mDeleteDrawable.getIntrinsicWidth();
